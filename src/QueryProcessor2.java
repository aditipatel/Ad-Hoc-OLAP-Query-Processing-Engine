...
QueryProcessor2 q = new QueryProcessor2();
List<Sales> salesList = q.getSalesData();
List<MFStructure> mfList = q.populateMFStructure(salesList,false,"prod,month,sum_quant_1,sum_quant_tot","prod,month","{year}[==]{1997}");
q.processPredicates(mfList,salesList,"{MF.prod.sum_quant_1}[=]{prod}:{MF.month.sum_quant_1}[=]{month},{MF.prod.sum_quant_tot}[=]{prod}","{year}[==]{1997}","prod,month","sum_quant_1,sum_quant_tot");
