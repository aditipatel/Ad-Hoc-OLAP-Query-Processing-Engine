...
public class QueryProcessor3{

class MFStructure{
public int month;
public String cust;
public int avg_quant;
public int avg_quant_before;
public int avg_quant_after;
...
QueryProcessor3 q = new QueryProcessor3();
List<Sales> salesList = q.getSalesData();
List<MFStructure> mfList = q.populateMFStructure(salesList,true,"cust,month,avg_quant,avg_quant_before,avg_quant_after","cust,month","{year}[==]{1997}");
q.processPredicates(mfList,salesList,"{MF.cust.avg_quant_before}[=]{cust}:{MF.month.avg_quant_before}[<]{month},{MF.cust.avg_quant_after}[=]{cust}:{MF.month.avg_quant_after}[>]{month}","{year}[==]{1997}","cust,month","avg_quant_before,avg_quant_after");
