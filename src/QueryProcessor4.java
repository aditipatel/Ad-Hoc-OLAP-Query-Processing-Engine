...
public class QueryProcessor4{

class MFStructure{
public String prod;
public String cust;
public int avg_quant_sale;
public int avg_quant_othrcustsale;
...
QueryProcessor4 q = new QueryProcessor4();
List<Sales> salesList = q.getSalesData();
List<MFStructure> mfList = q.populateMFStructure(salesList,false,"cust,prod,avg_quant_sale,avg_quant_othrcustsale","cust,prod","null");
q.processPredicates(mfList,salesList,"{MF.cust.avg_quant_sale}[=]{cust}:{MF.prod.avg_quant_sale}[=]{prod},{MF.prod.avg_quant_othrcustsale}[=]{prod}:{MF.cust.avg_quant_othrcustsale}[!=]{cust}","null","cust,prod","avg_quant_sale,avg_quant_othrcustsale");
