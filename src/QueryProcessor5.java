...
QueryProcessor5 q = new QueryProcessor5();
List<Sales> salesList = q.getSalesData();
List<MFStructure> mfList = q.populateMFStructure(salesList,false,"cust,avg_quant_NY,avg_quant_CT,avg_quant_NJ","cust","{year}[==]{1997}");
q.processPredicates(mfList,salesList,"{state}[=]{NY},{state}[=]{CT},{state}[=]{NJ}","{year}[==]{1997}","cust","avg_quant_NY,avg_quant_CT,avg_quant_NJ");
mfList = q.processHavingClause(mfList,"{avg_quant_NY,>,avg_quant_CT} [&&] {avg_quant_NY,>,avg_quant_NJ}");
